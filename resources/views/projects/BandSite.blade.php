            ...
            <div class="flex flex-col lg:flex-row gap-20">
                <div class="flex-1">
                    ...
                    <div class="grid md:grid-cols-2 gap-8 border-t border-white/5 pt-12">
                        <div>
                            <h3 class="text-white text-xs font-bold uppercase tracking-widest mb-4">Design Philosophy</h3>
                        ...
                        <div class="bg-indigo-500/5 border border-indigo-500/10 p-6 rounded-sm self-start">
                            <h3 class="text-indigo-400 text-[10px] font-bold uppercase tracking-widest mb-2">Technical Goal</h3>
                            <p class="text-xs text-slate-400 leading-relaxed italic">
                                Achieving a premium, media-heavy feel while keeping it barebones, using nothing but HTML, CSS, and JavaScript.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-80 space-y-6">
                    <div class="p-8 border border-slate-800 bg-slate-900/20">
                        <h4 class="text-[10px] font-bold text-indigo-400 uppercase tracking-widest mb-6">Technologies</h4>
