            ...
            <div class="flex flex-col lg:flex-row gap-20">
                <div class="flex-1">
                    ...
                    <div class="grid md:grid-cols-2 gap-8 border-t border-white/5 pt-12">
                        <div>
                            <h3 class="text-white text-xs font-bold uppercase tracking-widest mb-4">Rendering Pipeline</h3>
                        ...
                        <div class="bg-indigo-500/5 border border-indigo-500/10 p-6 rounded-sm self-start">
                            <h3 class="text-indigo-400 text-[10px] font-bold uppercase tracking-widest mb-2">The Learning Curve</h3>
                ...
                <div class="w-full lg:w-80 space-y-6">
                    <div class="p-8 border border-slate-800 bg-slate-900/20">
                        <h4 class="text-[10px] font-bold text-indigo-400 uppercase tracking-widest mb-6">Core Engine</h4>
                    ...
                    <button class="w-full py-4 bg-white text-black font-bold uppercase text-[10px] tracking-widest hover:bg-indigo-600 hover:text-white transition-all shadow-xl">
