        ...
        <div class="flex flex-col md:flex-row gap-16 items-start">
            ...
            <div class="w-full md:w-1/3">
                <div class="relative group">
                    <div class="aspect-[3/4] bg-slate-900 border border-slate-800 relative overflow-hidden">
                        ...
                        <div
                            class="absolute inset-0 flex items-center justify-center text-slate-800 uppercase tracking-[0.5em] text-xs font-bold -rotate-90">
                ...
                <div class="mt-12 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach (['PHP', 'Laravel', 'JS', 'ThreeJS', 'C#', 'Unity', 'Python'] as $skill)
                            <span
                                class="px-2 py-1 bg-indigo-500/5 text-indigo-400/80 border border-indigo-500/10 text-[9px] font-mono uppercase">
                                {{ $skill }}
                            </span>
                        @endforeach
                    </div>
            ...
            <div class="flex-1 space-y-10">
                ...
                <div class="prose prose-invert prose-slate text-slate-400 leading-relaxed">
                    <p>
                        I've independently learned <span class="text-white">Unity, ThreeJS, and Javascript</span> to
                        build immersive 3D environments, alongside developing robust backend systems with <span
                            class="text-white">Laravel</span>. I bridge the gap between technical reliability and
