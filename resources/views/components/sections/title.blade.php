    ...
    <div x-transition class="max-w-4xl">
        ...
        <div class="flex flex-wrap gap-4 items-center">
            ...
            <a href="https://github.com/KaketoeYT" target="_blank"
                ...
                <div
                    class="absolute top-0 right-0 w-2 h-2 border-t border-r border-indigo-500/40 group-hover:border-indigo-500">
                </div>
                ...
                <div class="flex flex-col items-start leading-none">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <svg class="w-3 h-3 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
